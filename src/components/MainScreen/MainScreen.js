...
import CounterApp from "../utilities/ConterApp"
...
class MainScreen extends Component {
  ...
  render() {
    ...
    function listOnPressFunction (props, obj,mee)  { 
      props.navigation.navigate("SecondScreen", { id: obj.id });
      ...
      switch(action.type)
        {
          case "INCREASE_COUNTER":
            return{mcounter:this.state.mcounter+1}
        }
        return state
    }
    ...
    return (
      <View style={{ flex: 1 }}>
        ...
        <StatusBar backgroundColor={Constants.Colors.Green} barStyle="light-content" />
            ...
            <View>
              {this.state.movieList.map(function(obj, i) {
                return (
                  ...
                  <TouchableOpacity
                    onPress={() => listOnPressFunction(this.props,obj,this)}
                    key={i} 
